...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-06-2023 a las 23:24:48
...
--
-- Estructura de tabla para la tabla `rolesu`
--
...
INSERT INTO `trabajadores` (`id_tra`, `ape_tra`, `dni_tra`, `est_tra`, `nom_tra`, `pass_tra`, `user_tra`, `empresa_id`, `rol_id`, `username`) VALUES
(1, 'TORRES', '78547689', b'1', 'JUAN2', '1212', 'ADMIN1', 1, 2, NULL),
(2, 'NOLASCO', '78547689', b'1', 'ALEXIS', '1212', 'ADMIN2', 1, 3, NULL),
(3, 'SUAREZ', '78547689', b'0', 'MARCO', '1212', 'ADMIN3', 1, 2, NULL),
(4, 'MARTINES', '78547689', b'0', 'RODRIGO', '1212', 'ADMIN4', 1, 1, NULL),
(5, 'SUAREZ', '78547689', b'1', 'MARCO', '1212', 'ADMIN5', 1, 1, NULL),
(6, 'MARTINES', '78547689', b'1', 'RODRIGO', '1212', 'ADMIN6', 2, 1, NULL),
(7, 'SUAREZ', '78547689', b'1', 'MARCO', '1212', 'ADMIN7', 2, 1, NULL),
(8, 'MARTINES', '78547689', b'1', 'RODRIGO', '1212', 'ADMIN8', 2, 1, NULL),
(9, 'SUAREZ', '78547689', b'1', 'MARCO', '1212', 'ADMIN9', 2, 1, NULL),
(10, 'MARTINES', '78547689', b'1', 'RODRIGO', '1212', 'ADMIN10', 2, 1, NULL),
(11, 'TORRES', '78547689', b'1', 'JUffgfdgfAN2', '1212', 'ADMIN1', 1, 2, NULL),
(12, 'Fuas2', '78547689', b'1', '', '4521', 'Assuu', 1, 2, NULL),
(13, 'wqewqe', '78545689', b'1', 'wsaqdwaqsdwq', '121212', 'wqewqe', 1, 2, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `trabajadores_roles`
--

CREATE TABLE `trabajadores_roles` (
...
--
-- Indices de la tabla `trabajadores_roles`
--
ALTER TABLE `trabajadores_roles`
  ADD PRIMARY KEY (`tra_id`,`rol_id`),
  ADD KEY `FK3bt0de8nembcejyce7xdbai9w` (`rol_id`);
...
--
-- AUTO_INCREMENT de la tabla `rolesu`
--
ALTER TABLE `rolesu`
...
--
-- Filtros para la tabla `trabajadores_roles`
--
ALTER TABLE `trabajadores_roles`
  ADD CONSTRAINT `FK3bt0de8nembcejyce7xdbai9w` FOREIGN KEY (`rol_id`) REFERENCES `rolesu` (`id`),
  ADD CONSTRAINT `FKgyqxvd5ar3qgn1limc6fe0b84` FOREIGN KEY (`tra_id`) REFERENCES `trabajadores` (`id_tra`);
COMMIT;
